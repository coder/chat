...
| [0012](adr/0012-concurrency-strategy.md) | Concurrency strategy expansion (`drop`/`queue`/`debounce`/`burst`/`concurrent`, lock scope, force/steerability) | Accepted (implemented) |
